...
<article class="flex flex-col rounded-[1.75rem] bg-gradient-to-b from-[#108A5E] to-[#0B3022] p-6 md:p-7 text-white shadow-lg ring-1 ring-black/5">
    ...
    <div class="mt-6 flex-1 space-y-3 text-sm leading-relaxed text-white/95">
        <div>
