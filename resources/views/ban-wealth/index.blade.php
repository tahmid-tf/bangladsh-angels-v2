...
(() => {
    ...
    function showFunds() {
        ...
        render(`<section class="bw-content"><h1>What we would put this money in</h1><p class="bw-lead">Every BAN Wealth fund is built to a mandate we set and reviewed by our investment team. Adjust either control and the shelf changes with it.</p>
