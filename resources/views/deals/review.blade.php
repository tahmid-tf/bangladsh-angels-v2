...
<div class="flex w-[70%] justify-start flex-col">
    ...
    <div class="flex flex-wrap gap-x-4 gap-y-2 mb-6">
        ...
        <a href="{{route('deals.invest')}}" class="text-gray-500 pb-2 text-sm max-w-[min(100%,22rem)] leading-snug text-center sm:text-left">Commit Investment / Express Interest to Invest</a>
