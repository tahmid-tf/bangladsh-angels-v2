    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <div class="flex flex-wrap items-center gap-4">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{route('investment.type.invest')}}" class="px-4 py-2 text-gray-600 hover:bg-gray-200 rounded-full">Interest</a>
        ...
        <table class="w-full table-auto">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-center text-gray-600 font-semibold">View deal</th>
                    <th class="px-4 py-2 text-center text-gray-600 font-semibold">Edit deal</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="px-4 py-2 text-center">
                        <a href="{{route('deal.view',$commit->deal)}}">
