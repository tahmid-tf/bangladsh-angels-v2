...
<section class="container mx-auto p-6">
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <div class="flex flex-wrap items-center gap-2 gap-y-3">
            ...
            <input type="text" placeholder="Search..." class="px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-green-200 focus:border-green-500 min-w-[12rem]" />
        </div>
    </div>
    @if(session('success'))
            ...
            <tbody>
                ...
                <tr class="border-t">
                    <td class="px-4 py-2 flex items-center space-x-4">
                        <img src="{{ $investment->deal->getLogoUrl() }}" alt="{{ $investment->deal->title }} Logo" class="h-[30px] rounded-full">
                        <div>
                    ...
                    <td class="px-4 py-2">{{ $investment->deal->description }}</td>
                    <td class="px-4 py-2 text-left">
                        @foreach($investment->deal->getKeyMetrics() as $metric)
                            <li>
                    ...
                    <td class="px-4 py-2 text-center">
                        <a href="{{ route('deal.view', $investment->deal) }}" title="Public deal page">
