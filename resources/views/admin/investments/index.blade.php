    ...
    <div class="bg-white rounded-lg shadow p-4 my-6">
        <div class="flex flex-wrap items-center gap-4">
            ...
            <div class="flex space-x-4">
                <a href="{{route('admin.investments')}}" class="px-4 py-2 bg-green-100 text-green-700 rounded-full">All</a>
        ...
        <table class="w-full table-auto">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-center text-gray-600 font-semibold">Type</th>
            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="px-4 py-2 text-center">
                        {{ucfirst($investment->deal->type)}}
                    </td>
                    <td class="px-4 py-2 text-center">
                        <a href="{{route('deal.view',$investment->deal->id)}}" class="w-full text-center">
