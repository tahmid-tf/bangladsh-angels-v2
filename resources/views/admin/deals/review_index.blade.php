...
<section class="container mx-auto p-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center p-4 bg-white shadow">
        <h1 class="text-lg md:text-xl font-bold mb-2 md:mb-0">Review Deals</h1>
    ...
    <div class="bg-white rounded-lg shadow p-4 my-6">
        @include('admin.deals.partials.tabs', ['activeDealTab' => 'review'])
    </div>

    <livewire:deals-table filter="review" />
</section>
@endsection
