...
@section('page_title', 'Add homepage program | Dashboard')
...
<div class="container w-full p-6 max-w-3xl">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold mt-4 text-gray-900">Add homepage program</h1>
    </div>
    ...
    <form method="post" action="{{ route('admin.landing-program-cards.store') }}" class="bg-white rounded-lg shadow p-6 space-y-6">
        @csrf
        @include('admin.landing-program-cards.form-fields', ['card' => null])
        <div class="flex gap-3">
            <button type="submit" class="px-6 py-2.5 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition">Add program</button>
