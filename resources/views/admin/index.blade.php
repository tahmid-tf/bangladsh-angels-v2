...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
  <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <a href="{{route('admin.members')}}">
      <div class="p-4 md:p-5 bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
        <div class="flex justify-between items-center mb-2">
          <h2 class="text-xl md:text-2xl font-bold text-gray-800">{{ count($users) }}</h2>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 md:h-8 md:w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <a href="{{route('admin.deals')}}">
      <div class="p-4 md:p-5 bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
        <div class="flex justify-between items-center mb-2">
          <h2 class="text-xl md:text-2xl font-bold text-gray-800">{{ count($deals)}}</h2>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 md:h-8 md:w-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <a href="{{route('admin.subscriptions')}}">
      <div class="p-4 md:p-5 bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
        <div class="flex justify-between items-center mb-2">
          <h2 class="text-xl md:text-2xl font-bold text-gray-800">{{ count($subscriptions) }}</h2>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 md:h-8 md:w-8 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="p-4 md:p-5 bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
      <div class="flex justify-between items-center mb-2">
        <h2 class="text-xl md:text-2xl font-bold text-gray-800">BDT {{ number_format($totalRevenue, 2) }}</h2>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 md:h-8 md:w-8 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mt-6">
    ...
    <div class="p-4 md:p-5 bg-white rounded-lg shadow">
      <h2 class="text-lg font-bold mb-4 text-gray-800">Member Sign Ups</h2>
      <div class="chart-container" style="position: relative; height:40vh; max-height: 250px;">
  ...
  <div class="grid grid-cols-1 gap-6 mt-6">
    <div class="p-4 md:p-5 bg-white rounded-lg shadow">
      ...
      <div class="flex flex-col lg:flex-row lg:mb-4">
        <div class="w-full lg:w-1/2 lg:pr-4 mb-6 lg:mb-0">
          <h3 class="font-bold text-md mb-2 text-gray-700">Recent Payments</h3>
          <div class="overflow-x-auto">
            <table class="min-w-full leading-normal">
              <thead>
                <tr>
                  <th class="px-3 md:px-5 py-2 md:py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                    Member
                  </th>
                  <th class="px-3 md:px-5 py-2 md:py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                    Amount
              ...
              <tbody>
                ...
                <tr>
                  <td class="px-3 md:px-5 py-2 border-b border-gray-200 bg-white text-sm">
                    <div class="truncate max-w-[120px] md:max-w-full">{{ $payment->user->name ?? 'Unknown' }}</div>
                  </td>
                  <td class="px-3 md:px-5 py-2 border-b border-gray-200 bg-white text-sm">
                ...
                @empty
                <tr>
                  <td colspan="4" class="px-3 md:px-5 py-5 border-b border-gray-200 bg-white text-sm text-center text-gray-500">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full leading-normal">
              ...
              <tbody>
                ...
                <tr>
                  <td class="px-3 md:px-5 py-2 border-b border-gray-200 bg-white text-sm">
                    <div class="truncate max-w-[120px] md:max-w-full">{{ $subscription->user->name ?? 'Unknown' }}</div>
                  </td>
                  <td class="px-3 md:px-5 py-2 border-b border-gray-200 bg-white text-sm">
